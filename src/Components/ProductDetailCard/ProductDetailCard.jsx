...
const ProductDetailCard = ({Data}) => {
  return (
    <div className="ProductDetailCard">
        ...
        <li className="ProductDetailCard-detail">
            {Data.Descripition}</li>
        ...
        <div className="ProductDetailCard-PriceandDelivery">
           <div className="pricecontainer">
            <p className="ProductDetailCard-price">
              {Data.Sellingprice}</p>
            <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/fa_62673a.png" height={21} alt="" />
           </div>
            <p className="freedel">Free delivery</p>
            <p className="discount">
                Upto <b>17,500</b> off on Exchange
                No Cost EMI from 23,317/month
            </p>
        </div>
    </div>
